@echo off
REM NeuroTurk Hermes Agents - Toplu Kurulum
REM Kullanim: install-all.bat

echo NeuroTurk Hermes Agents kurulumu basliyor...
...
echo Tum agentlar kuruldu!
echo Kullanim: ollama run neuroturk-agent-adi
pause
